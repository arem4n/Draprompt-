...
🚀 Cómo Usar
Instalación
 * Descarga draprompt-v2.8.2.md o draprompt-lite-v2.8.2.md
 * Copia todo el contenido
 * Pégalo al inicio de tu conversación con cualquier LLM
 * Activa el modo que necesites: 🐉 modo ORÁCULO
Ejemplo Rápido
...
📚 Documentación
 * EXAMPLES_FULL.md - Casos de uso avanzados con todas las funcionalidades
 * draprompt-v2.8.2.md - Sistema completo (recomendado)
 * draprompt-lite-v2.8.2.md - Versión condensada
🎮 Sistema de Niveles
 ...
 * Mantén la atribución a Sergio Arellano (CC BY 4.0)
📄 Licencia
